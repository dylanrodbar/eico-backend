...
Post.create({title: "Cuarta publicación", description: "Cuarta descripción", video: "Cuarto video", date: "2018-02-03", media: "https://res.cloudinary.com/poppycloud/image/upload/v1528815838/mz7iyumqenyinfmwn5rj.jpg", user_id: 1})
Post.create({title: "Quinta publicación", description: "Quinta descripción", video: "Quinto video", date: "2018-02-03", media: "https://res.cloudinary.com/poppycloud/image/upload/v1528815838/mz7iyumqenyinfmwn5rj.jpg", user_id: 1})
Post.create({title: "Sexta publicación", description: "Sexta descripción", video: "Sexto video", date: "2018-02-03", media: "https://res.cloudinary.com/poppycloud/image/upload/v1528815838/mz7iyumqenyinfmwn5rj.jpg", user_id: 1})
